...
export interface Prisma {
  ...
  wishlist: (where: WishlistWhereUniqueInput) => WishlistPromise;
  wishlists: (
    args?: {
  ...
  updateManyHauls: (
    args: { data: HaulUpdateManyMutationInput; where?: HaulWhereInput }
  ) => BatchPayloadPromise;
  upsertHaul: (
    args: {
  ...
  updateWishlist: (
    args: { data: WishlistUpdateInput; where: WishlistWhereUniqueInput }
  ) => WishlistPromise;
  upsertWishlist: (
    args: {
...
export interface UserCreateOneWithoutHaulsInput {
...
export interface UserCreateWithoutHaulsInput {
  username: String;
  password: String;
  specialCode?: String;
  email: String;
...
export interface UserUpdateOneRequiredWithoutHaulsInput {
  create?: UserCreateWithoutHaulsInput;
...
export interface UserUpdateWithoutHaulsDataInput {
  username?: String;
  password?: String;
  specialCode?: String;
  email?: String;
...
export interface UserUpsertWithoutHaulsInput {
  update: UserUpdateWithoutHaulsDataInput;
  create: UserCreateWithoutHaulsInput;
}
...
export interface HaulUpdateWithWhereUniqueWithoutUserInput {
  where: HaulWhereUniqueInput;
...
export interface HaulCreateWithoutUserInput {
  items?: ItemCreateManyInput;
  weight: Int;
}
...
export interface HaulCreateManyWithoutUserInput {
  create?: HaulCreateWithoutUserInput[] | HaulCreateWithoutUserInput;
...
export interface HaulUpdateManyDataInput {
  weight?: Int;
}
...
export interface HaulUpsertWithWhereUniqueWithoutUserInput {
  where: HaulWhereUniqueInput;
...
export interface HaulUpdateManyWithoutUserInput {
  create?: HaulCreateWithoutUserInput[] | HaulCreateWithoutUserInput;
  ...
  update?:
    | HaulUpdateWithWhereUniqueWithoutUserInput[]
    | HaulUpdateWithWhereUniqueWithoutUserInput;
  upsert?:
    | HaulUpsertWithWhereUniqueWithoutUserInput[]
    | HaulUpsertWithWhereUniqueWithoutUserInput;
  deleteMany?: HaulScalarWhereInput[] | HaulScalarWhereInput;
  updateMany?:
    | HaulUpdateManyWithWhereNestedInput[]
    | HaulUpdateManyWithWhereNestedInput;
}
...
export interface HaulUpdateManyWithWhereNestedInput {
...
export interface HaulUpdateManyMutationInput {
  weight?: Int;
}
...
export interface HaulUpdateWithoutUserDataInput {
  items?: ItemUpdateManyInput;
  weight?: Int;
}
